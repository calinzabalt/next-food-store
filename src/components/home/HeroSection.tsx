    ...
    return (
        <section className="relative bg-gray-900 text-white overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 py-24 md:py-32 lg:py-40 flex flex-col items-start justify-center min-h-[600px]">
                <span className="inline-block px-4 py-2 rounded-full bg-orange-500/20 text-orange-400 font-bold text-sm mb-6 backdrop-blur-sm border border-orange-500/30">
